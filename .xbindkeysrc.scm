...
;; Show all commands
;; [Ctrl-Alt-s]
(xbindkey '(control alt s) "xbindkeys_show")

;; Open terminal
;; [Ctrl-Alt-t]
(xbindkey '(control alt t) "konsole")

;; Open superuser terminal
;; [Ctrl-Alt-u]
(xbindkey '(control alt u) "konsole --title Shell\ -\ Konsole\ \(Superuser\) --icon @icons_dir@/dn-xbindkeys-superuser.png -e su")

;; Run GVim
;; [Ctrl-Alt-v]
(xbindkey '(control alt v) "gvim")
...
;; Show time
;; [Alt-F10]
(xbindkey '(mod1 F10) "dn-show-time")

;; Open web browser
;; [Ctrl-Alt-b]
(xbindkey '(control alt b) "qutebrowser")

;; Volume up
;; [XF86AudioRaiseVolume]
(xbindkey '(XF86AudioRaiseVolume) "pactl set-sink-mute @DEFAULT_SINK@ false ; pactl set-sink-volume @DEFAULT_SINK@ +5%")

;; Volume down
;; [XF86AudioLowerVolume]
(xbindkey '(XF86AudioLowerVolume) "pactl set-sink-mute @DEFAULT_SINK@ false ; pactl set-sink-volume @DEFAULT_SINK@ -5%")
